...
# absolute paths to the results jsons of EDA on the dataset to be replicated
...
# location where poisson debug files should be saved
IF_DEBUG_FILES = True
DEBUG_FILES_PATH = "/some/path/"