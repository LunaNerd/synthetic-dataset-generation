...
DATA_DIR = Path("/project_ghent/luversmi/dataset/synthetic_data/experiment_truncnorm")


if __name__ == "__main__":
    dataset_name = "coco_truncnorm_4400"  # Give your dataset a name
    ...
    if not docker:
        ...
        object_json = "/project_ghent/luversmi/dataset/foreground/experiment_flowering/foreground_1500_tot.json"
